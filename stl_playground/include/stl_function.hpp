 ...
 * @version: 
 * @Author: tylerytr
 * @Date: 2023-10-16 10:41:30
 * @LastEditTime: 2023-10-16 16:47:15
 * @LastEditors: tylerytr
 * @FilePath: /stl_playground/include/stl_function.hpp
...
struct Function {
    // 只在使用了不符合 Ret(Args...) 模式的 FnSig 时出错；比如Function<void>
...
public:
    ...
    // 这里的F之所以不用外部使用的时候显示的指定，是因为编译器会推断类型然后自动填充;可以在cppinsight看出
